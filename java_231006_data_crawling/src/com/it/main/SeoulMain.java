         ...
         for(int i=1;i<=1;i++)	//14
         {
            ...
            for(int j=0;j<poster.size();j++)
            {
              ...
              // Element address=doc2.select("div.detail-map-infor:eq(1) dl dd").get(0);
               Elements address=doc2.select("div.detail-map-infor first border dl dd");
               System.out.println("address" + address);
               System.out.println("주소:"+address.get(1).text());
               System.out.println("=========================================================");
